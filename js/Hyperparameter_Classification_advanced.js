...
function getAlgorithmParameters(algorithm) {
  const parameterMappings = {
    ...
    logistic: ["lr_C", "lr_penalty"],
    lasso: ["lasso_C"],
    svm: ["svm_C", "svm_kernel", "svm_gamma"],
    xgboost: ["xgb_n_estimators", "xgb_learning_rate", "xgb_max_depth"],
    lightgbm: [
      "lgb_n_estimators",
      "lgb_learning_rate",
      "lgb_max_depth",
...
app.registerExtension({
  name: "ComfyQSAR_HyperparameterTuning_Classification_Advanced",

  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    if (nodeData.name !== "Hyperparameter_Grid_Search_Classification") return;
