...
class RandomForest_CL:
    ...
    def random_forest_feature_selection(self, descriptor_data_path, target_column, n_estimators, max_depth,
        ...
        for i in range(n_iterations):
            model = RandomForestClassifier(n_estimators=n_estimators, max_depth=current_max_depth,
                                           min_samples_split=min_samples_split, criterion=criterion, random_state=i)
            model.fit(X, y)
        ...
        filename = f"features_random_forest_RF_{initial_feature_count}_{final_feature_count}.csv"
...
NODE_CLASS_MAPPINGS = {
    "random_forest_CL": RandomForest_CL,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "random_forest_CL": "5.2 Random Forest Selection",
}
